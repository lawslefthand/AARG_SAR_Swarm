...
def main():
    ...
    takeoff(mav_connection, args.altitude,-35.3630160,149.1652179)
    takeoff(mav_connection, args.altitude,-35.3627491,149.1651857)
    takeoff(mav_connection, args.altitude,-35.3627885,149.1649523)
    takeoff(mav_connection, args.altitude,-35.3627645,149.1655008)
    takeoff(mav_connection, args.altitude,-35.3626310,149.1651884)
